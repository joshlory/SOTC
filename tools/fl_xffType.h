...
struct t_xffSymRelEnt {	//Table with Relative addreses of entries in symTab 
...
struct t_xffRelocEnt { //Relocation Entry - holds addresses of the two (addr & instr) tables for relocating contents of a given section.
   //00 type
   //4 
   //9    
