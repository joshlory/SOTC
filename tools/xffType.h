...
struct xSymRelEnt_t {	//Table with Relative addreses of entries in symTab 
	u32	addr;
};
...
struct xRelocEnt_t { //Relocation Entry - holds addresses of the two (addr & instr) tables for relocating contents of a given section.
   //00 type
   //4 
   //9    
